...
async function makeStructuredApiCall<T>(
    model: string,
    userPrompt: string,
    schema: Schema<T>,
    systemPrompt: string
 ...
 */
export async function jsonLLM_fast<T>(
  userPrompt: string,
  schema: Schema<T>,
  systemPrompt: string,
): Promise<T> {
 ...
 */
export async function jsonLLM_formatter<T>(
 ...
 */
export async function jsonLLM_aggregator<T>(
  userPrompt: string,
  schema: Schema<T>,
  systemPrompt: string,
): Promise<T> {
